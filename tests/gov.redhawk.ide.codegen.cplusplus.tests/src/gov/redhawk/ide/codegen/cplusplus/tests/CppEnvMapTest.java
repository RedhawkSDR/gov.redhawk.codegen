...
import gov.redhawk.ide.codegen.cplusplus.CppEnvMap;
...
public class CppEnvMapTest {
	...
	public static final String PLUGIN_ID = "gov.redhawk.ide.codegen.cplusplus.tests";
	...
	public void testCreatePath() throws CoreException, URISyntaxException, IOException {
		...
		Assert.assertEquals(new File(file, "lib").toString(), map.createPath("lib/", uri));
		Assert.assertEquals(new File(file, "lib").toString(), map.createPath("lib/test.so", uri));
	}
