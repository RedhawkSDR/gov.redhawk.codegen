 ...
 */
package gov.redhawk.ide.codegen.python.tests;
...
import gov.redhawk.ide.codegen.python.internal.PythonEnvMap;
...
public class PythonEnvMapTest {
	...
	private static final String PLUGIN_ID = "gov.redhawk.ide.codegen.python.tests";
