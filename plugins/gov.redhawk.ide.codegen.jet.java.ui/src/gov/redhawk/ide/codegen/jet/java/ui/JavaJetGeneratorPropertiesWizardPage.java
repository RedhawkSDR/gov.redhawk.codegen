				...
				if (desc != null) {
					if (desc != JavaJetGeneratorPropertiesWizardPage.this.selectedTemplate) {
						...
						if (JavaJetGeneratorPropertiesWizardPage.this.propBinding != null) {
							JavaJetGeneratorPropertiesWizardPage.this.bindings.remove(JavaJetGeneratorPropertiesWizardPage.this.propBinding);
						}
						JavaJetGeneratorPropertiesWizardPage.this.propBinding = createPropertyBinding();
						JavaJetGeneratorPropertiesWizardPage.this.bindings.add(JavaJetGeneratorPropertiesWizardPage.this.propBinding);
					}
					...
					JavaJetGeneratorPropertiesWizardPage.this.templateViewer.getCombo().setToolTipText(desc.getDescription());
				} else {
		...
		if (this.codegen != null) {
			...
			if (this.packageNameText != null) {
				if ("".equals(this.packageName.getValue())) {
					this.packageName.setValue(JavaGeneratorProperties.getPackage(this.softPkg, this.impl, this.implSettings));
					this.packageNameText.setText(this.packageName.getValue());
				}
			}
		} else {
