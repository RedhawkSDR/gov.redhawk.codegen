...
public class UsesPortJavaTemplate
{
  ...
  protected final String TEXT_66 = NL + "\t\t\t\tStreamSRI sri = new StreamSRI();" + NL + "\t\t\t\tsri.mode = 0;" + NL + "\t\t\t\tsri.xdelta = 0.0;" + NL + "\t\t\t\tsri.ydelta = 0.0;" + NL + "\t\t\t\tsri.subsize = 0;" + NL + "\t\t\t\tsri.xunits = 1; // TIME_S" + NL + "\t\t\t\tsri.streamID = streamID;";
  protected final String TEXT_67 = NL + "\t\t\t\tStreamSRI sri = new StreamSRI();" + NL + "\t\t\t\tsri.mode = 0;" + NL + "\t\t\t\tsri.xdelta = 1.0;" + NL + "\t\t\t\tsri.ydelta = 0.0;" + NL + "\t\t\t\tsri.subsize = 0;" + NL + "\t\t\t\tsri.xunits = 1; // TIME_S" + NL + "\t\t\t\tsri.streamID = streamID;";
  ...
  protected final String TEXT_79 = " failed\");" + NL + "                    }" + NL + "                }" + NL + "" + NL + "                //begin-user-code" + NL + "                //end-user-code" + NL + "            }" + NL + "        }    // don't want to process while command information is coming in" + NL + "        " + NL + "        return;" + NL + "    }";
