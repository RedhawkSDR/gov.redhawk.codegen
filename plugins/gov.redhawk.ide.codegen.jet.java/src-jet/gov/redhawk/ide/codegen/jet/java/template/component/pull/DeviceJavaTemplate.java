...
public class DeviceJavaTemplate
{
  ...
  protected final String TEXT_89 = NL + " \t *" + NL + " \t * -User can custom design allocation and deallocation" + NL + " \t * -Otherwise basic auto alloc / dealloc will be user" + NL + " \t *" + NL + " \t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + " \t */" + NL + "    public class ";
