...
import mil.jpeojtrs.sca.prf.impl.SimpleImpl;
 ...
 * @generated
 */
public class DeviceJavaTemplate
{

  protected static String nl;
  public static synchronized DeviceJavaTemplate create(String lineSeparator)
  {
    nl = lineSeparator;
    DeviceJavaTemplate result = new DeviceJavaTemplate();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_3 = ";" + NL + "" + NL + "import java.util.ArrayList;" + NL + "import java.util.HashMap;" + NL + "import java.util.Properties;" + NL + "import org.omg.PortableServer.POAPackage.ServantNotActive;" + NL + "import org.omg.PortableServer.POAPackage.WrongPolicy;" + NL + "import CF.DataType;" + NL + "import CF.InvalidObjectReference;" + NL + "import CF.DevicePackage.AdminType;" + NL + "import CF.DevicePackage.OperationalType;" + NL + "import CF.DevicePackage.UsageType;" + NL + "import org.apache.log4j.Logger;" + NL + "import org.ossie.component.*;";
  ...
  protected final String TEXT_12 = NL + NL + "/**" + NL + " * This is the Device code. This file contains all the access points" + NL + " * you need to use to be able to access all input and output ports," + NL + " * respond to incoming data, and perform general device housekeeping" + NL + " *" + NL + " * Source: ";
  ...
  protected final String TEXT_18 = " extends Device implements Runnable {" + NL + "    /**" + NL + "     * @generated" + NL + "     */" + NL + "    public final static Logger logger = Logger.getLogger(";
  protected final String TEXT_19 = ".class.getName());" + NL + "    ";
  ...
  protected final String TEXT_42 = "() " + NL + "    {" + NL + "        super();" + NL + "       \tthis.usageState = UsageType.IDLE;" + NL + "      \tthis.operationState = OperationalType.ENABLED;" + NL + "      \tthis.adminState = AdminType.UNLOCKED;" + NL + "      \tthis.callbacks = new HashMap<String, AllocCapacity>();";
  ...
  protected final String TEXT_50 = NL + "\t\t// Inits the call back classes";
  protected final String TEXT_51 = NL + "\t\t";
  protected final String TEXT_52 = "_callback ";
  protected final String TEXT_53 = "_call_var = new ";
  protected final String TEXT_54 = "_callback();";
  protected final String TEXT_55 = NL + NL + "\t\t// Adds call backs to map";
  protected final String TEXT_56 = NL + "\t\tcallbacks.put(";
  protected final String TEXT_57 = ".getId(), ";
  protected final String TEXT_58 = "_call_var);";
  protected final String TEXT_59 = NL + NL + "        // Provides/input";
  protected final String TEXT_60 = NL + "        this.port_";
  protected final String TEXT_61 = " = new MessageConsumerPort(\"";
  protected final String TEXT_62 = "\");" + NL + "        this.addPort(\"";
  protected final String TEXT_63 = "\", this.port_";
  protected final String TEXT_64 = ");";
  protected final String TEXT_65 = NL + "        this.port_";
  protected final String TEXT_66 = " = new ";
  protected final String TEXT_67 = "InPort(this, \"";
  protected final String TEXT_68 = "\");" + NL + "        this.addPort(\"";
  protected final String TEXT_69 = "\", this.port_";
  protected final String TEXT_70 = ");";
  protected final String TEXT_71 = NL + NL + "        // Uses/output";
  protected final String TEXT_72 = NL + "        this.port_";
  protected final String TEXT_73 = " = new PropertyEventSupplier(\"";
  protected final String TEXT_74 = "\");";
  protected final String TEXT_75 = NL + "        this.port_";
  protected final String TEXT_76 = " = new ";
  protected final String TEXT_77 = "_";
  protected final String TEXT_78 = "OutPort(\"";
  protected final String TEXT_79 = "\");";
  protected final String TEXT_80 = NL + "        this.port_";
  protected final String TEXT_81 = " = new ";
  protected final String TEXT_82 = "OutPort(\"";
  protected final String TEXT_83 = "\");";
  protected final String TEXT_84 = NL + "        this.addPort(\"";
  protected final String TEXT_85 = "\", this.port_";
  protected final String TEXT_86 = ");";
  protected final String TEXT_87 = NL + "    " + NL + "       //begin-user-code" + NL + "       //end-user-code" + NL + "    }" + NL + "    " + NL + "    ";
  protected final String TEXT_88 = NL + " \t/**" + NL + " \t * Call back class for ";
  protected final String TEXT_89 = NL + " \t *" + NL + " \t * -User can custom design allocation and deallocation" + NL + " \t * -Otherwise basic auto alloc / dealloc will be used" + NL + " \t *" + NL + " \t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + " \t */" + NL + "    public class ";
  protected final String TEXT_90 = "_callback implements AllocCapacity {" + NL + "    \tpublic boolean allocate(DataType t) {" + NL + "    \t\t/* - TODO User defined allocate functions go here" + NL + "    \t\t * - Returns:" + NL + "    \t\t *\t\ttrue  -> successful allocate" + NL + "    \t\t *\t\tfalse -> failure to allocate" + NL + "    \t\t */" + NL + "\t\t\tlogger.trace(\"Attempting user defined allocate\");" + NL + "    \t\treturn false;" + NL + "    \t}" + NL + "\t\tpublic boolean deallocate(DataType t){" + NL + "    \t\t/* - TODO User defined deallocate functions go here" + NL + "    \t\t * - Returns :" + NL + "    \t\t *      true  -> if user specifies their own function" + NL + "    \t\t *      false -> if no deallocate function is defined" + NL + "    \t\t */" + NL + "\t\t\tlogger.trace(\"Attempting user defined deallocate\");" + NL + "    \t\t return false;" + NL + "    \t}" + NL + "    }" + NL + "\t";
  protected final String TEXT_91 = NL;
  protected final String TEXT_92 = NL + NL + "    /**" + NL + "     * @generated" + NL + "     */" + NL + "    public CF.Resource setup(final String compId, final String compName, final ORB orb, final POA poa) throws ServantNotActive, WrongPolicy" + NL + "    {" + NL + "    \tCF.Resource retval = super.setup(compId, compName, orb, poa);" + NL + "    \t";
  protected final String TEXT_93 = NL + "        this.port_";
  protected final String TEXT_94 = ".registerProperty(this.compId, this.compName, this.";
  protected final String TEXT_95 = ");";
  protected final String TEXT_96 = NL + "        " + NL + "        this.registerPropertyChangePort(this.port_";
  protected final String TEXT_97 = ");" + NL + "        " + NL + "        //begin-user-code" + NL + "        //end-user-code" + NL + "        " + NL + "    \treturn retval;" + NL + "    }";
  protected final String TEXT_98 = NL + "    ";
  protected final String TEXT_99 = NL + "    /**" + NL + "     * @generated" + NL + "     */" + NL + "    @Override" + NL + "\tpublic void initialize() throws InitializeError {" + NL + "\t\tsuper.initialize();";
  protected final String TEXT_100 = NL + "\t\ttry {" + NL + "\t\t\tsuper.start();" + NL + "\t\t} catch (StartError e) {" + NL + "\t\t\tthrow new InitializeError(\"Error auto-starting device\", new String[] { e.msg });" + NL + "\t\t}";
  protected final String TEXT_101 = NL + "\t}" + NL;
  protected final String TEXT_102 = NL + "    /**" + NL + "     * @generated" + NL + "     */" + NL + "    public boolean compareSRI(StreamSRI SRI_1, StreamSRI SRI_2){" + NL + "        if (SRI_1.hversion != SRI_2.hversion)" + NL + "            return false;" + NL + "        if (SRI_1.xstart != SRI_2.xstart)" + NL + "            return false;" + NL + "        if (SRI_1.xdelta != SRI_2.xdelta)" + NL + "            return false;" + NL + "        if (SRI_1.xunits != SRI_2.xunits)" + NL + "            return false;" + NL + "        if (SRI_1.subsize != SRI_2.subsize)" + NL + "            return false;" + NL + "        if (SRI_1.ystart != SRI_2.ystart)" + NL + "            return false;" + NL + "        if (SRI_1.ydelta != SRI_2.ydelta)" + NL + "            return false;" + NL + "        if (SRI_1.yunits != SRI_2.yunits)" + NL + "            return false;" + NL + "        if (SRI_1.mode != SRI_2.mode)" + NL + "            return false;" + NL + "        if (SRI_1.streamID != SRI_2.streamID)" + NL + "            return false;" + NL + "        if (SRI_1.keywords.length != SRI_2.keywords.length)" + NL + "            return false;" + NL + "        String action = \"eq\";" + NL + "        for (int i=0; i < SRI_1.keywords.length; i++) {" + NL + "            if (!SRI_1.keywords[i].id.equals(SRI_2.keywords[i].id)) {" + NL + "                return false;" + NL + "            }" + NL + "            if (!SRI_1.keywords[i].value.type().equivalent(SRI_2.keywords[i].value.type())) {" + NL + "                return false;" + NL + "            }" + NL + "            if (AnyUtils.compareAnys(SRI_1.keywords[i].value, SRI_2.keywords[i].value, action)) {" + NL + "                return false;" + NL + "            }" + NL + "        }" + NL + "        return true;" + NL + "    }" + NL;
  protected final String TEXT_103 = NL + "    /**" + NL + "     * @generated" + NL + "     */" + NL + "    public boolean compareTime(final PrecisionUTCTime T1, final PrecisionUTCTime T2){" + NL + "    \tif (T1.tcmode != T2.tcmode)" + NL + "    \t\treturn false;" + NL + "    \tif (T1.tcstatus != T2.tcstatus)" + NL + "    \t\treturn false;" + NL + "    \tif (T1.tfsec != T2.tfsec)" + NL + "    \t\treturn false;" + NL + "    \tif (T1.toff != T2.toff)" + NL + "    \t\treturn false;" + NL + "    \tif (T1.twsec != T2.twsec)" + NL + "    \t\treturn false;" + NL + "    \treturn true;" + NL + "    }" + NL + "" + NL + "    /**" + NL + "     * This method is used to handle the attach call and return an attachId for the connection." + NL + "     * The value of the attachId should be unique across attach calls within this device instance." + NL + "     * " + NL + "     * @param stream the new stream definition" + NL + "     * @param userId the userId for the stream" + NL + "     * @return an id for this attach call that is unique across all calls within this device instance." + NL + "\t * @throws AttachError" + NL + "\t * @throws StreamInputError" + NL + "     * @generated" + NL + "     */" + NL + "\tpublic String attach(SDDSStreamDefinition stream, String userId) throws AttachError, StreamInputError {" + NL + "\t\tString attachId = \"\";" + NL + "\t\t" + NL + "        //begin-user-code" + NL + "\t\t// TODO Fill in this method to handle attach and set attachId to a value unique to this device " + NL + "        //end-user-code" + NL + "" + NL + "\t\treturn attachId;" + NL + "\t}" + NL + "" + NL + "\t/**" + NL + "     * This method is used to handle the detach call." + NL + "\t * " + NL + "\t * @param attachId the attachId from a previous call to attach" + NL + "\t * @throws DetachError" + NL + "\t * @throws StreamInputError" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic void detach(String attachId) throws DetachError, StreamInputError {" + NL + "        //begin-user-code" + NL + "\t\t// TODO Fill in this method to handle detach " + NL + "        //end-user-code" + NL + "\t}" + NL;
  protected final String TEXT_104 = NL + "    /**" + NL + "     *" + NL + "     * Main processing thread" + NL + "     *" + NL + "     * <!-- begin-user-doc -->" + NL + "     * " + NL + "     * General functionality:" + NL + "     * " + NL + "     *    This function is running as a separate thread from the device's main thread. " + NL + "     *    " + NL + "     *    The IDE uses JMerge during the generation (and re-generation) process.  To keep" + NL + "     *    customizations to this file from being over-written during subsequent generations," + NL + "     *    put your customization in between the following tags:" + NL + "     *      - //begin-user-code" + NL + "     *      - //end-user-code" + NL + "     *    or, alternatively, set the @generated flag located before the code you wish to " + NL + "     *    modify, in the following way:" + NL + "     *      - \"@generated NOT\"" + NL + "     * " + NL + "     * StreamSRI:" + NL + "     *    To create a StreamSRI object, use the following code:" + NL + "     *        this.stream_id = \"stream\";" + NL + "     * \t\t  StreamSRI sri = new StreamSRI();" + NL + "     * \t\t  sri.mode = 0;" + NL + "     * \t\t  sri.xdelta = 0.0;" + NL + "     * \t\t  sri.ydelta = 1.0;" + NL + "     * \t\t  sri.subsize = 0;" + NL + "     * \t\t  sri.xunits = 1; // TIME_S" + NL + "     * \t\t  sri.streamID = (this.stream_id.getValue() != null) ? this.stream_id.getValue() : \"\";" + NL + "     * " + NL + "     * PrecisionUTCTime:" + NL + "     *    To create a PrecisionUTCTime object, use the following code:" + NL + "     * \t\t  long tmp_time = System.currentTimeMillis();" + NL + "     * \t\t  double wsec = tmp_time / 1000;" + NL + "     * \t\t  double fsec = tmp_time % 1000;" + NL + "     * \t\t  PrecisionUTCTime tstamp = new PrecisionUTCTime(BULKIO.TCM_CPU.value, (short)1, (short)0, wsec, fsec);" + NL + "     * " + NL + "     * Ports:" + NL + "     * " + NL + "     *    Each port instance is accessed through members of the following form: this.port_<PORT NAME>" + NL + "     * " + NL + "     *    Data is obtained in the run function through the getPacket call (BULKIO only) on a" + NL + "     *    provides port member instance. The getPacket function call is non-blocking; it takes" + NL + "     *    one argument which is the time to wait on new data. If you pass 0, it will return" + NL + "     *    immediately if no data available (won't wait)." + NL + "     *    " + NL + "     *    To send data, call the appropriate function in the port directly. In the case of BULKIO," + NL + "     *    convenience functions have been added in the port classes that aid in output." + NL + "     *    " + NL + "     *    Interactions with non-BULKIO ports are left up to the device developer's discretion." + NL + "     *    " + NL + "     * Properties:" + NL + "     * " + NL + "     *    Properties are accessed through members of the same name with helper functions. If the " + NL + "     *    property name is baudRate, then reading the value is achieved by: this.baudRate.getValue();" + NL + "     *    and writing a new value is achieved by: this.baudRate.setValue(new_value);" + NL + "     *    " + NL + "     * Example:" + NL + "     * " + NL + "     *    This example assumes that the device has two ports:" + NL + "     *        - A provides (input) port of type BULKIO::dataShort called dataShort_in" + NL + "     *        - A uses (output) port of type BULKIO::dataFloat called dataFloat_out" + NL + "     *    The mapping between the port and the class is found the class of the same name." + NL + "     *    This example also makes use of the following Properties:" + NL + "     *        - A float value called amplitude with a default value of 2.0" + NL + "     *        - A boolean called increaseAmplitude with a default value of true" + NL + "     *    " + NL + "     *    BULKIO_dataShortInPort.Packet<short[]> data = this.port_dataShort_in.getPacket(125);" + NL + "     *" + NL + "     *    if (data != null) {" + NL + "     *        float[] outData = new float[data.getData().length];" + NL + "     *        for (int i = 0; i < data.getData().length; i++) {" + NL + "     *            if (this.increaseAmplitude.getValue()) {" + NL + "     *                outData[i] = (float)data.getData()[i] * this.amplitude.getValue();" + NL + "     *            } else {" + NL + "     *                outData[i] = (float)data.getData()[i];" + NL + "     *            }" + NL + "     *        }" + NL + "     *" + NL + "     *        // NOTE: You must make at least one valid pushSRI call" + NL + "     *        if (data.sriChanged()) {" + NL + "     *            this.port_dataFloat_out.pushSRI(data.getSRI());" + NL + "     *        }" + NL + "     *        this.port_dataFloat_out.pushPacket(outData, data.getTime(), data.getEndOfStream(), data.getStreamID());" + NL + "     *    }" + NL + "     *      " + NL + "     * <!-- end-user-doc -->" + NL + "     * " + NL + "     * @generated" + NL + "     */" + NL + "    public void run() " + NL + "    {" + NL + "        //begin-user-code" + NL + "        //end-user-code" + NL + "        " + NL + "        while(this.started())" + NL + "        {" + NL + "            //begin-user-code" + NL + "            // Process data here" + NL + "            try {" + NL + "                logger.debug(\"run() example log message\");" + NL + "                Thread.sleep(1000);" + NL + "            } catch (InterruptedException e) {" + NL + "                break;" + NL + "            }" + NL + "            " + NL + "            //end-user-code" + NL + "        }" + NL + "        " + NL + "        //begin-user-code" + NL + "        //end-user-code" + NL + "    }" + NL + "        " + NL + "    /**" + NL + "     * The main function of your device.  If no args are provided, then the" + NL + "     * CORBA object is not bound to an SCA Domain or NamingService and can" + NL + "     * be run as a standard Java application." + NL + "     * " + NL + "     * @param args" + NL + "     * @generated" + NL + "     */" + NL + "    public static void main(String[] args) " + NL + "    {" + NL + "        final Properties orbProps = new Properties();" + NL + "" + NL + "        //begin-user-code" + NL + "        // TODO You may add extra startup code here, for example:" + NL + "        // orbProps.put(\"com.sun.CORBA.giop.ORBFragmentSize\", Integer.toString(fragSize));" + NL + "        //end-user-code" + NL + "" + NL + "        try {" + NL + "            Device.start_device(";
  protected final String TEXT_105 = ".class, args, orbProps);" + NL + "        } catch (InvalidObjectReference e) {" + NL + "            e.printStackTrace();" + NL + "        } catch (ServantNotActive e) {" + NL + "            e.printStackTrace();" + NL + "        } catch (WrongPolicy e) {" + NL + "            e.printStackTrace();" + NL + "        } catch (InstantiationException e) {" + NL + "            e.printStackTrace();" + NL + "        } catch (IllegalAccessException e) {" + NL + "            e.printStackTrace();" + NL + "        }" + NL + "" + NL + "        //begin-user-code" + NL + "        // TODO You may add extra shutdown code here" + NL + "        //end-user-code" + NL + "    }" + NL + "}";
