...
public class SandboxTestsActivator implements BundleActivator {
	...
	public static void initSdrRoot() throws IOException, URISyntaxException, InterruptedException {
		...
		SdrUiPlugin.getDefault()
		        .getPreferenceStore()
		        .setValue(SdrUiPreferenceConstants.SCA_LOCAL_SDR_PATH_PREFERENCE, new File(fileURL.toURI()).getAbsolutePath());
		root.reload(null);
