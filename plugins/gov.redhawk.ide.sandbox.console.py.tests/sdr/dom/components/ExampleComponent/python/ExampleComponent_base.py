...
# Generated on: Tue Jun 26 10:10:05 EDT 2012
...
class PortBULKIODataFloatIn_i(ExampleComponent_base.PortBULKIODataFloatIn):
...
class PortBULKIODataFloatOut_i(ExampleComponent_base.PortBULKIODataFloatOut):
    class linkStatistics:
        class statPoint:
            def __init__(self):
                self.elements = 0
