 ...
 * @since 10.0
 */
public class GeneratorStub extends AbstractPythonGenerator {
	...
	protected void generateCode(Implementation impl, ImplementationSettings implSettings, IProject project, String componentName, PrintStream out, // SUPPRESS CHECKSTYLE Arguments
		...
		throw new CoreException(new Status(IStatus.ERROR, PythonJetGeneratorPlugin.PLUGIN_ID, "Unsupported Code Generator"));
	}
