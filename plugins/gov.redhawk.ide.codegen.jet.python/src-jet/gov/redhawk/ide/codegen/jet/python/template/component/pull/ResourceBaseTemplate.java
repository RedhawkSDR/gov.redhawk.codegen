...
public class ResourceBaseTemplate
{
  ...
  protected final String TEXT_45 = NL + "            loggerName = (execparams['DEVICE_LABEL'].replace('/', '.')).rsplit(\"_\", 1)[0]" + NL + "            ExecutableDevice.__init__(self, devmgr, uuid, label, softwareProfile, compositeDevice, execparams,loggerName=loggerName)";
  protected final String TEXT_46 = NL + "            loggerName = (execparams['DEVICE_LABEL'].replace('/', '.')).rsplit(\"_\", 1)[0]" + NL + "            LoadableDevice.__init__(self, devmgr, uuid, label, softwareProfile, compositeDevice, execparams,loggerName=loggerName)";
  protected final String TEXT_47 = NL + "            loggerName = (execparams['DEVICE_LABEL'].replace('/', '.')).rsplit(\"_\", 1)[0]" + NL + "            Device.__init__(self, devmgr, uuid, label, softwareProfile, compositeDevice, execparams,loggerName=loggerName)";
