...
public class LegacyResourcePropertiesTemplate
{

  protected static String nl;
  public static synchronized LegacyResourcePropertiesTemplate create(String lineSeparator)
  {
    nl = lineSeparator;
    LegacyResourcePropertiesTemplate result = new LegacyResourcePropertiesTemplate();
    nl = null;
    return result;
  }
