...
public class PortGeneratorTemplate
{
  ...
  protected final String TEXT_103 = NL + "                self.sriDict[streamID] = copy.deepcopy(sri)" + NL + "            self.pushSRI(self.sriDict[streamID])" + NL + "" + NL + "        self.port_lock.acquire()" + NL + "" + NL + "        try:    " + NL + "            try:" + NL + "                for connId, port in self.outConnections.items():" + NL + "                    if port != None:" + NL + "                        port.";
  ...
  protected final String TEXT_111 = " failed on port %s connection %s instance %s\", self.name, connId, port)" + NL + "                raise" + NL + "            if EOS==True:" + NL + "                if self.sriDict.has_key(streamID):" + NL + "                    tmp = self.sriDict.pop(streamID)" + NL + "        finally:" + NL + "            self.port_lock.release()" + NL;
  ...
  protected final String TEXT_137 = NL + "        self.port_lock.acquire()" + NL + "" + NL + "        try:    " + NL + "            try:" + NL + "                for connId, port in self.outConnections.items():" + NL + "                    if port != None:" + NL + "                        retVal = port._get_";
  ...
  protected final String TEXT_141 = "(self, data):" + NL + "        self.port_lock.acquire()" + NL + "" + NL + "        try:    " + NL + "            try:" + NL + "                for connId, port in self.outConnections.items():" + NL + "                    if port != None:" + NL + "                        port._set_";
