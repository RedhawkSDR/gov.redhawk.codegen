...
public class ResourceSpecTemplate
{
  ...
  protected final String TEXT_24 = NL + NL + NL + "%prep" + NL + "%setup" + NL + "" + NL + "" + NL + "%build";
  ...
  protected final String TEXT_30 = NL + "%configure" + NL + "make %{?_smp_mflags}" + NL + "popd";
  protected final String TEXT_31 = NL + NL + NL + "%install" + NL + "rm -rf $RPM_BUILD_ROOT";
  ...
  protected final String TEXT_38 = NL + NL + NL + "%clean" + NL + "rm -rf $RPM_BUILD_ROOT" + NL + "" + NL + "" + NL + "%files" + NL + "%defattr(-,redhawk,redhawk,-)" + NL + "%dir %{_prefix}/";
