...
public class IdlSpecTemplate
{
  ...
  protected final String TEXT_4 = NL + "Release:        1%{?dist}" + NL + "" + NL + "Group:          REDHAWK/Interfaces" + NL + "License:        None" + NL + "Source:         %{name}-%{version}.tar.gz " + NL + "BuildRoot:      %{_tmppath}/%{name}-%{version}-%{release}-buildroot" + NL + "" + NL + "BuildRequires:  redhawk-devel >= 2.0" + NL + "Requires:       redhawk >= 2.0" + NL + "" + NL + "" + NL + "%description" + NL + "Libraries and interface definitions for ";
