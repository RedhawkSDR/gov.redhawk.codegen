...
public class FrontendSwitch<T> extends Switch<T>
{
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      {
        FeiDevice feiDevice = (FeiDevice)theEObject;
        T result = caseFeiDevice(feiDevice);
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>Fei Device</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Fei Device</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseFeiDevice(FeiDevice object)
  {
    return null;
  }
