 ...
 * 
 */
public class OssieLibClasspathContainerInitializer extends ClasspathContainerInitializer {

	/**
	 * 
	 */
	public OssieLibClasspathContainerInitializer() {
	...
	public void initialize(final IPath containerPath, final IJavaProject javaProject) throws CoreException {
		JavaCore.setClasspathContainer(ScaCore.OSSIE_LIB_CONTAINER_PATH, new IJavaProject[] { javaProject },
		        new IClasspathContainer[] { new OssieLibClasspathContainer() }, null);
	}
