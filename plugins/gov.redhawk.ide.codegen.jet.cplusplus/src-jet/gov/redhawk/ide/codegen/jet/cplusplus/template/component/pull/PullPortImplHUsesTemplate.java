...
public class PullPortImplHUsesTemplate
{
  ...
  protected final String TEXT_45 = ", T, EOS, streamID.c_str());" + NL + "                        stats[(*port).second].update(1, 0, 0, streamID);" + NL + "                    } catch(...) {" + NL + "                        std::cout << \"Call to pushPacket by ";
  protected final String TEXT_46 = "_";
  protected final String TEXT_47 = "_Out_i failed\" << std::endl;" + NL + "                    }" + NL + "                }" + NL + "            }" + NL + "        };";
  ...
  protected final String TEXT_55 = "), 0, 0, streamID);" + NL + "                    } catch(...) {" + NL + "                        std::cout << \"Call to pushPacket by ";
  protected final String TEXT_56 = "_";
  protected final String TEXT_57 = "_Out_i failed\" << std::endl;" + NL + "                    }" + NL + "                }" + NL + "            }" + NL + "        };";
  ...
  protected final String TEXT_71 = "_var, std::string > >::iterator port;" + NL + "                for (port = outConnections.begin(); port != outConnections.end(); port++) {" + NL + "                    try {" + NL + "                        ((*port).first)->pushPacket(seq, T, EOS, streamID.c_str());" + NL + "                        stats[(*port).second].update(data.size(), 0, 0, streamID);" + NL + "                    } catch(...) {" + NL + "                        std::cout << \"Call to pushPacket by ";
  protected final String TEXT_72 = "_";
  protected final String TEXT_73 = "_Out_i failed\" << std::endl;" + NL + "                    }" + NL + "                }" + NL + "            }" + NL + "        };";
