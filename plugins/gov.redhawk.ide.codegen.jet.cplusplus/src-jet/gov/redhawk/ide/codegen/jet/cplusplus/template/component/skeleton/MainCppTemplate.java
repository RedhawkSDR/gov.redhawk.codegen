...
public class MainCppTemplate
{
  ...
  protected final String TEXT_10 = "_i(component_identifier.c_str(), component_running, name_binding.c_str(), orb);";
  protected final String TEXT_11 = NL + "    ";
  protected final String TEXT_12 = "_var = ";
  protected final String TEXT_13 = "_servant->_this();" + NL + "    " + NL + "    CORBA::Object_var applicationObject = orb->orb->string_to_object(naming_context_ior.c_str());" + NL + "    CosNaming::NamingContext_ptr applicationContext = CosNaming::NamingContext::_narrow(applicationObject);" + NL + "    " + NL + "    orb->bind_object_to_name((CORBA::Object_ptr) ";
  protected final String TEXT_14 = "_var, applicationContext, name_binding.c_str());" + NL + "" + NL + "    // This bit is ORB specific" + NL + "    // omniorb is threaded and the servants are running at this point" + NL + "    // so we block on the condition" + NL + "    // The releaseObject method clear the condition and the component exits" + NL + "" + NL + "    component_running->wait();" + NL + "    orb->unbind_name(applicationContext, name_binding.c_str());" + NL + "    orb->orb->shutdown(0);" + NL + "" + NL + "}";
