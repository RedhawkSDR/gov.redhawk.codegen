 ...
 * @generated
 */
public class DPortImplHTemplate
{

  protected static String nl;
  public static synchronized DPortImplHTemplate create(String lineSeparator)
  {
    nl = lineSeparator;
    DPortImplHTemplate result = new DPortImplHTemplate();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_162 = "_i *parent;" + NL + "        BULKIO::StreamSRISequence currentHs;" + NL + "        boost::mutex sriUpdateLock;" + NL + "        bool sriChanged;" + NL + "        BULKIO::PortUsageType currentState;" + NL + "        // statistics" + NL + "        linkStatistics stats;" + NL;
  protected final String TEXT_163 = NL + "    private:";
  protected final String TEXT_164 = NL + "    ";
  protected final String TEXT_165 = " vector_";
  protected final String TEXT_166 = "_";
  protected final String TEXT_167 = ";" + NL + "    ";
  protected final String TEXT_168 = NL;
  protected final String TEXT_169 = NL + "class ";
  protected final String TEXT_170 = "_";
  protected final String TEXT_171 = "_In_i : public POA_";
  protected final String TEXT_172 = "::";
  protected final String TEXT_173 = ", public Port_Provides_base_impl" + NL + "{" + NL + "    public:";
  protected final String TEXT_174 = NL + "        ";
  protected final String TEXT_175 = "_";
  protected final String TEXT_176 = "_In_i(std::string port_name, ";
  protected final String TEXT_177 = "_i *_parent);" + NL + "        ~";
  protected final String TEXT_178 = "_";
  protected final String TEXT_179 = "_In_i();" + NL;
  ...
  protected final String TEXT_191 = NL + "        void ";
  protected final String TEXT_192 = "(";
  protected final String TEXT_193 = " data);" + NL;
  protected final String TEXT_194 = NL + "    private:";
  protected final String TEXT_195 = NL + "    ";
  protected final String TEXT_196 = " vector_";
  protected final String TEXT_197 = "_";
  protected final String TEXT_198 = ";" + NL + "    ";
  protected final String TEXT_199 = NL + "};" + NL + "#endif" + NL;
