...
public class DMainCppTemplate
{
  ...
  protected final String TEXT_8 = "Device, \"Device halted\")" + NL + "}" + NL + "" + NL + "int main(int argc, char *argv[])" + NL + "{" + NL + "    ossie::ORB *orb = new ossie::ORB;" + NL + "    struct sigaction sa;" + NL + "    sa.sa_handler = signal_catcher;" + NL + "    sa.sa_flags = 0;" + NL + "" + NL + "    Device_impl::start_device(&devicePtr, sa, argc, argv);" + NL + "}";
