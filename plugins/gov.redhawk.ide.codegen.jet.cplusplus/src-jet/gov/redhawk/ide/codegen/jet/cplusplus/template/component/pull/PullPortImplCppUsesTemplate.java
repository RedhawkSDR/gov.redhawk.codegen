...
public class PullPortImplCppUsesTemplate
{
  ...
  protected final String TEXT_53 = " retval";
  protected final String TEXT_54 = " = ";
  protected final String TEXT_55 = ";";
  protected final String TEXT_56 = NL + "    std::vector < std::pair < ";
  protected final String TEXT_57 = "::";
  protected final String TEXT_58 = "_var, std::string > >::iterator i;" + NL + "" + NL + "    boost::mutex::scoped_lock lock(updatingPortsLock);   // don't want to process while command information is coming in" + NL;
  protected final String TEXT_59 = NL + "    Sequence_";
  protected final String TEXT_60 = "_";
  protected final String TEXT_61 = ".length(";
  protected final String TEXT_62 = ".size());" + NL + "    memcpy(&Sequence_";
  protected final String TEXT_63 = "_";
  protected final String TEXT_64 = "[0], &";
  protected final String TEXT_65 = "[0], ";
  protected final String TEXT_66 = ".size() * sizeof(";
  protected final String TEXT_67 = "[0]));" + NL;
  protected final String TEXT_68 = NL + "    if (active) {" + NL + "        for (i = outConnections.begin(); i != outConnections.end(); ++i) {" + NL + "            try {" + NL + "                ";
  protected final String TEXT_69 = "retval =";
  protected final String TEXT_70 = "((*i).first)->";
  protected final String TEXT_71 = "(";
  protected final String TEXT_72 = ");";
  protected final String TEXT_73 = "Sequence_";
  protected final String TEXT_74 = "_";
  protected final String TEXT_75 = ");";
  protected final String TEXT_76 = ", ";
  protected final String TEXT_77 = NL + "            } catch(...) {" + NL + "                std::cout << \"Call to ";
  protected final String TEXT_78 = " by ";
  protected final String TEXT_79 = "_";
  protected final String TEXT_80 = "_Out_i failed\" << std::endl;" + NL + "            }" + NL + "        }" + NL + "    }" + NL + "" + NL + "    return";
  protected final String TEXT_81 = " retval";
  protected final String TEXT_82 = ";" + NL + "}";
  protected final String TEXT_83 = NL;
  protected final String TEXT_84 = " ";
  protected final String TEXT_85 = "_";
  protected final String TEXT_86 = "_Out_i::";
  protected final String TEXT_87 = "()" + NL + "{";
  protected final String TEXT_88 = NL + "    ";
  protected final String TEXT_89 = " retval";
  protected final String TEXT_90 = " = ";
  protected final String TEXT_91 = ";";
  protected final String TEXT_92 = NL + "    std::vector < std::pair < ";
  protected final String TEXT_93 = "::";
  protected final String TEXT_94 = "_var, std::string > >::iterator i;" + NL + "" + NL + "    boost::mutex::scoped_lock lock(updatingPortsLock);   // don't want to process while command information is coming in" + NL + "    " + NL + "    if (active) {" + NL + "        for (i = outConnections.begin(); i != outConnections.end(); ++i) {" + NL + "            try {" + NL + "                retval = ((*i).first)->";
  protected final String TEXT_95 = "();" + NL + "            } catch(...) {" + NL + "                std::cout << \"Call to ";
  protected final String TEXT_96 = " by ";
  protected final String TEXT_97 = "_";
  protected final String TEXT_98 = "_Out_i failed\" << std::endl;" + NL + "            }" + NL + "        }" + NL + "    }" + NL + "" + NL + "    return";
  protected final String TEXT_99 = " retval";
  protected final String TEXT_100 = ";" + NL + "}" + NL;
  protected final String TEXT_101 = NL + "void ";
  protected final String TEXT_102 = "_";
  protected final String TEXT_103 = "_Out_i::";
  protected final String TEXT_104 = "(";
  protected final String TEXT_105 = " data)" + NL + "{" + NL + "    std::vector < std::pair < ";
  protected final String TEXT_106 = "::";
  protected final String TEXT_107 = "_var, std::string > >::iterator i;" + NL + "" + NL + "    boost::mutex::scoped_lock lock(updatingPortsLock);   // don't want to process while command information is coming in" + NL + "    " + NL + "    if (active) {" + NL + "        for (i = outConnections.begin(); i != outConnections.end(); ++i) {" + NL + "            try {" + NL + "                ((*i).first)->";
  protected final String TEXT_108 = "(data);" + NL + "            } catch(...) {" + NL + "                std::cout << \"Call to ";
  protected final String TEXT_109 = " by ";
  protected final String TEXT_110 = "_";
  protected final String TEXT_111 = "_Out_i failed\" << std::endl;" + NL + "            }" + NL + "        }" + NL + "    }" + NL + "" + NL + "    return;" + NL + "}" + NL;
