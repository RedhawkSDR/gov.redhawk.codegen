...
public class PortImplCppTemplate
{
  ...
  protected final String TEXT_115 = NL + "    stats.update(";
  protected final String TEXT_116 = "1";
  protected final String TEXT_117 = ".length()";
  protected final String TEXT_118 = ", EOS, streamID);";
  protected final String TEXT_119 = NL + "    stats.update(strlen(";
  protected final String TEXT_120 = "), EOS, streamID);";
  protected final String TEXT_121 = NL + "    new_message.resize(";
  protected final String TEXT_122 = ".length());" + NL + "    memcpy(&new_message[0], &";
  protected final String TEXT_123 = "[0], ";
  protected final String TEXT_124 = ".length() * sizeof(";
  protected final String TEXT_125 = "[0]));" + NL + "    ";
  protected final String TEXT_126 = NL + NL + "    // This is somewhat dangerous. The const_cast<> removes the const on the data" + NL + "    // sequence that's passed in so we can call get_buffer on it. get_buffer(1)" + NL + "    // essentially steals the buffer out of the sequence from OmniORB. However," + NL + "    // once you do this you MUST delete the buffer when you're done with it" + NL + "    // otherwise you'll run out of memory.  By doing this, we reduce the transfers" + NL + "    // to one memcpy/connection for the send process." + NL + "    //" + NL + "    // MAKE SURE TO DELETE THIS BUFFER!!!!!" + NL + "    unsigned long length = ";
  protected final String TEXT_127 = ".length();" + NL + "    new_message = const_cast<";
  protected final String TEXT_128 = "*>(&";
  protected final String TEXT_129 = ")->get_buffer(1);" + NL + "    ";
  protected final String TEXT_130 = NL + NL + "    parent->";
