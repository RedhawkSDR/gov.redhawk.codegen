 ...
 * @since 11.0
 */
public class GeneratorStub extends AbstractCplusplusCodeGenerator {
	...
	protected void generateCode(Implementation impl, ImplementationSettings implSettings, IProject project, String componentName, PrintStream out, // SUPPRESS CHECKSTYLE Arguments
		...
		throw new CoreException(new Status(IStatus.ERROR, CplusplusJetGeneratorPlugin.PLUGIN_ID, "Unsupported Code Generator"));
	}
